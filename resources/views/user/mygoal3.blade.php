...
<body>
    ...
    <div class="mandara">
        <table border="2" class="left_top">
            ...
            <tr><td><button type="button" class="btn btn-page" data-toggle="modal" data-target="#exampleModal"></button></td>
                <td bgcolor="#1760a0"><button type="button" class="btn btn-page" data-toggle="modal" data-target="#exampleModal"></button></td>
                <td><button type="button" class="btn btn-page" data-toggle="modal" data-target="#exampleModal"></button></td></tr>
            <tr><td><button type="button" class="btn btn-page" data-toggle="modal" data-target="#exampleModal"></button></td>
                <td><button type="button" class="btn btn-page" data-toggle="modal" data-target="#exampleModal"></button></td>
                <td><button type="button" class="btn btn-page" data-toggle="modal" data-target="#exampleModal"></button></td></tr>
    ...
    <div class="mandara_middle">
        ...
        <table border="2">
            <tr><td bgcolor="#1760a0"><button type="button" class="btn btn-page" data-toggle="modal" data-target="#exampleModal"></button></td>
                <td bgcolor="#1760a0"><button type="button" class="btn btn-page" data-toggle="modal" data-target="#exampleModal"></button></td>
                <td bgcolor="#1760a0"><button type="button" class="btn btn-page" data-toggle="modal" data-target="#exampleModal"></button></td></tr>
            <tr><td bgcolor="#1760a0"><button type="button" class="btn btn-page" data-toggle="modal" data-target="#exampleModal"></button></td>
                <td bgcolor="#cc0000"><button type="button" class="btn btn-page" data-toggle="modal" data-target="#exampleModal"></button></td>
                <td bgcolor="#1760a0"><button type="button" class="btn btn-page" data-toggle="modal" data-target="#exampleModal"></button></td></tr>
            <tr><td bgcolor="#1760a0"><button type="button" class="btn btn-page" data-toggle="modal" data-target="#exampleModal"></button></td>
                <td bgcolor="#1760a0"><button type="button" class="btn btn-page" data-toggle="modal" data-target="#exampleModal"></button></td>
                <td bgcolor="#1760a0"><button type="button" class="btn btn-page" data-toggle="modal" data-target="#exampleModal"></button></td></tr>
...
<nav aria-label="Page navigation example">
  <ul class="pagination justify-content-end">
    <li class="page-item disabled">
      <a class="page-link" href="mygoal2" tabindex="-1">Previous</a>
    </li>
    ...
    <li class="page-item">
      <a class="page-link" href="mygoal">Next</a>
    </li>
  </ul>
</nav>
