...
<body>
    ...
    <div class="mandara">
        <table border="2" class="left_top">
            <tr><td>@if(isset($items)){{ $items->content }}@endif<button type="button" class="btn btn-page" data-toggle="modal" data-target="#exampleModal" data-whatever="position1"></button></td>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="POST" action="mygoal">
    {{ csrf_field() }}
      ...
      <div class="modal-footer">
        ...
        <a href="mygoal"><input type="submit" class="btn btn-primary" value="保存"></a>
      </div>
      </form>
    </div>
  </div>
...
<script type="text/javascript" src="mygoal.js"></script>
</body>
</html>