...
<body>
    ...
    <div class="mandara">
        <table border="2" class="left_top">
            <tr><td>@if(isset($items[1])){{ $item[1] }}@endif<button type="button" class="btn btn-page" data-toggle="modal" data-target="#exampleModal" data-whatever="position1"></button></td>
